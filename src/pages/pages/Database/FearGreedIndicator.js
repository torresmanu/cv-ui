      ...
      <Grid container justify="center" spacing={2} style={{ marginTop: '1em' }}>
        <Grid item>
          <Icon
            ...
            width="40"
            height="40"
            style={{ color: 'red', backgroundColor: 'rgba(255, 0, 0, 0.2)', borderRadius: '50%', padding: '5px' }}
          />
        ...
        <Grid item>
          <Icon
            ...
            width="40"
            height="40"
            style={{ color: 'green', backgroundColor: 'rgba(0, 255, 0, 0.2)', borderRadius: '50%', padding: '5px' }}
          />
